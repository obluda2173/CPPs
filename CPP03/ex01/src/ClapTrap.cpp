...
/*   Updated: 2025/02/22 11:17:15 by erian            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::~ClapTrap() {
	std::cout << RED << "claptrap " << _name << " destroyed" << NC << std::endl;
}
...
void ClapTrap::attack(std::string const &target) {
	std::cout << DARK_RED << "claptrap " << _name << " attacks " << target << " causing " << _attack_damage << " points of damage!" << NC << std::endl;
}
